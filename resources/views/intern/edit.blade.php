...
<body>
	...
	<form action="{{route('interns.update',$intern->id)}}" method="post" enctype="multipart/form-data">
		...
		<div class="card border-0 shadow-lg">
			<div class="card-body">
      			...
      			<div class="form-group row mt-3">
				    ...
				    <div class="col-md-6">
				        <input type="text" name="name" placeholder="Enter your Name" class="form-control @error('name') is-invalid @enderror" value="{{old('name', $intern->name)}}">
				        @error('name')
				...
				<div class="form-group row mt-3">
				    ...
				    <div class="col-md-6">
				        <input type="text" name="email" placeholder="Enter your Email" class="form-control @error('email') is-invalid @enderror"value="{{old('email', $intern->email)}}">
				         @error('email')
				        <p class="invalid-feedback">{{ $message }}</p> 
				        @enderror
				    </div>
				    ...
				    <div class="col-md-6">
				        ...
				        @enderror
				         ...
				         @if($intern->image != '' && file_exists(public_path().'/uploads/interns/'.$intern->image))
                            <img src="{{ url('uploads/interns/'.$intern->image) }}" alt="" width="40" height="40" >
		...
		<button class="btn btn-primary my-3">Update Intern</button>
	</form>
	</div>
</div>
